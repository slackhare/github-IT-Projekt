...
def main():
    ...
    parser.add_argument('--number_of_trys', type=int, default=100,
                       help='number of trys')
...
def nextSentence(args):
    ...
    with tf.Session() as sess:
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            retunText = model.nextPart(sess, chars, vocab, args.prime, args.number_of_sentences, args.number_of_trys, 1)
            #print(retunText)
    return retunText
