...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='../allSaves/512-4-100-2-wiki',
    ...
    parser.add_argument('--learning_rate', type=float, default=0.0007, #0.002
                       help='learning rate')
    parser.add_argument('--decay_rate', type=float, default=0.97,
                       help='decay rate for rmsprop')                       
    parser.add_argument('--init_from', type=str, default='../allSaves/256-3-100-wiki',
            ...
            for b in range(data_loader.num_batches):
                ...
                print("{}/{} (epoch {}), train_loss = {:.3f}, time/batch = {:.3f}, {}" \
                    .format(e * data_loader.num_batches + b,
                            ...
                            e, train_loss, end - start, args.data_dir))
